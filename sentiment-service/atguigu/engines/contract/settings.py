...
class Settings(BaseSettings):
    ...
    INSIGHT_AGENT_MODEL_NAME: str = Field("kimi-k2-0711-preview", description="Insight 角色模型名")
    ...
    MEDIA_AGENT_MODEL_NAME: str = Field("gemini-2.5-pro", description="Media 角色模型名")
