...
from atguigu.engines.contract.evidence import Engagement
from atguigu.engines.contract.settings import get_settings
from atguigu.engines.insight_agent.tools.search_results import EvidenceDocument, SearchHit
from atguigu.engines.insight_agent.tools.vector.embedder import VectorEmbedder
from atguigu.engines.insight_agent.tools.vector.builder import (
